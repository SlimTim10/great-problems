...
*** Setting up S3 for files

- Create an [[https://www.linode.com/docs/products/storage/object-storage/get-started/][Object Storage bucket with Linode]]
- [[https://www.linode.com/docs/products/storage/object-storage/guides/s3cmd/][Install and configure s3cmd]]
- Edit the environment variables in ~config/backend/s3.env~
